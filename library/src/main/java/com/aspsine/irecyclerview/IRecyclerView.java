...
import com.aspsine.irecyclerview.interfaces.OnLoadMoreScrollListener;
...
//        }
    ...
    public void setLoadMoreState(String msg){
        if (!(mLoadMoreFooterView instanceof LoadMoreTrigger)){
            throw new ClassCastException("LoadMore View must be an implement of LoadMoreTrigger");
        }
        if (TextUtils.isEmpty(msg)){
            ((LoadMoreTrigger) mLoadMoreFooterView).onNoMoreData();
        }else {
            ((LoadMoreTrigger) mLoadMoreFooterView).onLoadFailed(msg);
        }
    }
    ...
    public void setRefreshHeaderView(Context context) {
        ensureRefreshHeaderContainer();
        final View refreshHeader = new RecyclerHeaderView(context);
        setRefreshHeaderView(refreshHeader);
    }
    ...
    public void setLoadMoreFooterView(Context context) {
        ensureLoadMoreFooterContainer();
        View loadMoreFooter = new RecyclerFooterView(context);
        setLoadMoreFooterView(loadMoreFooter);
    ...
    private RefreshTrigger mRefreshTrigger = new RefreshTrigger() {
        ...
        public void onRefresh() {
            ...
            if (mLoadMoreFooterView != null && mLoadMoreFooterView instanceof LoadMoreTrigger){
                ((LoadMoreTrigger) mLoadMoreFooterView).onReset();
            }
        }
